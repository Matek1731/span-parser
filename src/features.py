...
class FeatureMapper(object):
    ...
    def vocab_init(fname, verbose=True):
        ...
        trees = phrase_tree.PhraseTree.load_treefile(fname)
        ...
        for i, tree in enumerate(trees):
            ...
            for action in parser.Parser.gold_actions(tree):
    ...
    def gold_data(self, reftree):
        ...
        (s_features, l_features) = parser.Parser.training_data(reftree)
